...
lexicalKnowledge(_,_,all(A,imp(entity(A),entity(A)))).

%lexicalKnowledge(movie,0,Axiom):-
%   Axiom = all(A,imp(entity(A),entity(A))).
%
%lexicalKnowledge(friday,0,Axiom):-
%   Axiom = all(A,imp(entity(A),entity(A))).
%
%lexicalKnowledge(evt,3,Axiom):-
%   Axiom = all(A,imp(entity(A),entity(A))).
%
%
